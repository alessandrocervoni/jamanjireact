...
export default function RestaurantDetail(props)
{
    ...
    return (
        <>
            <div style={{ minHeight: '100vh', backgroundImage: `url('http://localhost:3000/Sfondo.png')`,  backgroundSize: 'contain', backgroundPosition: 'center center'  }}>
                <div style={{ display: "flex", justifyContent: "center" }}>
                    <div
                        className="restaurant-info"
                        style={{
                            border: "2px solid rgba(0, 0, 0, 0)", // Imposta il bordo trasparente con opacità al 50%
                            padding: "10px",
                            textAlign: "center",
                            maxWidth: "500px",
                            width: "100%",
                    ...
                    >
                        <br></br>
                        <h5 className="card-title text-bold">{restaurant.name}</h5>
                        <br></br>

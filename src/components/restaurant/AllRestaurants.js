...
export default function AllRestaurants() {
    ...
    function FilterForm() {
        ...
        return (
            ...
            {/* <br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br> */}
                <div className="card text-center mb-3" style={{ position: "sticky", top: "450px", width: "18rem", margin: "3% auto" }}>
                        ...
                        <form>
                            ...
                            <div className="d-grid">
                                {isFiltered ? (
                                    ...
                                    <button onClick={filter} type="button" className="btn btn-dark">Filter now</button>
                                )}
                            </div>
                        </form>
                    </div>
                                ...
                                <div key={restaurant.id} className="col-md-4">
                                    <div className="card h-100">
                                        <div className="card-body">
                                            ...
                                            <Link to={"/restaurantDetail/" + restaurant.id + "/" + user.id} className="btn btn-dark">Go to Restaurant Detail</Link>
                                        </div>
                                    </div>
                                </div>
                            );
    ...
    return (
        <div className="p-3 text-center" style={{ minHeight: '100vh', backgroundImage: `url('http://localhost:3000/Sfondo.png')`, backgroundSize: 'contain', backgroundPosition: 'center center' }}>
            <div className="row">
